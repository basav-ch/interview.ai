      ...
      <div className="flex-1 px-6 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          rounded-full flex items-center gap-2"
            >
              <HiSparkles size={16} className="bg-gray-50 text-green-600" />
          ...
          <div className="text-center mb-28">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10">
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className="border border-gray-400 bg-white px-10 py-3 rounded-full
        ...
        items-center gap-10 mb-28"
          >
            {[
              ...
              border-2 border-green-500 text-green-600 w-16 h-16 rounded-2xl flex items-center 
                ...
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2">
                      <div
                        className="bg-green-50 text-green-600 w-12 h-12 rounded-xl flex items-center
                  justify-center mb-6"
                      >
                        {item.icon}
                      </div>
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between gap-6">
                    ...
                    {/* RIGHT IMAGE */}
                    <div className="w-1/2 flex jsutify-end">
                      <img
                        src={mode.image}
                        alt={mode.title}
