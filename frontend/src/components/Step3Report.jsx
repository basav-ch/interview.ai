...
function Step3Report({ report }) {
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Excellent clarity and structural responses.";
  } else if (finalScore >= 5) {
    performanceText = "Minor improvement is required before interview.";
    shortTagline = "Good foundation, refine articulation.";
  } else {
    performanceText = "Significant improvement is required.";
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      ...
      advice =
        "Good foundation shown. Improve clarity and structure. Practice delivering concise, confindent answers with stronger supporting examples.";
    } else {
      advice =
        "Significant improvement is required. Focus on structured thinking, clarity, and confident delivery. Practice answering aloud regularly.";
    }
